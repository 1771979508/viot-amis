...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.renderColumn = function (column, key, length) {
        ...
        return (React.createElement("div", { key: key, className: cx(copProps2Class(colProps), fromBsClass(column.columnClassName), (_a = {},
                ...
                _a), setThemeClassName(__assign(__assign({}, column), { name: 'baseControlClassName', id: id, themeCss: themeCss })), setThemeClassName(__assign(__assign({}, column), { name: 'wrapperCustomStyle', id: id, themeCss: themeCss }))), style: styleVar },
            ...
            React.createElement(CustomStyle, __assign({}, column, { config: {
    ...
    Grid.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('Grid', (_a = {},
                ...
                _a), className, setThemeClassName(__assign(__assign({}, this.props), { name: 'baseControlClassName', id: id, themeCss: themeCss })), setThemeClassName(__assign(__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle }))), style: styleVar, "data-id": id },
