...
import { isApiOutdated, resolveVariableAndFilter, getVariable, autobind, ScopedContext, Renderer } from 'amis-core';
...
var PdfViewer = /** @class */ (function (_super) {
    ...
    PdfViewer.prototype.fetchPdf = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, env, src, data, finalSrc, resolveSrc, res, error_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (src) {
                            resolveSrc = resolveVariableAndFilter(src, data, '| raw');
    ...
    PdfViewer.prototype.renderTip = function () {
        return (React.createElement("div", null,
            React.createElement("p", null, "[PdfViewer]: pdfjsWorkerSrc is required, Please set the `pdfjsWorkerSrc` in env.")));
    };
    PdfViewer.prototype.render = function () {
        var _a = this.props, className = _a.className, cx = _a.classnames; _a.translate; var height = _a.height, background = _a.background;
        var pdfjs = this.props.env.pdfjsWorkerSrc;
        ...
        return (React.createElement("div", { ref: this.wrapper },
            this.renderEmpty(),
            !pdfjs ? (this.renderTip()) : (React.createElement(Suspense, { fallback: React.createElement("div", null, "...") }, inited && !error ? (React.createElement(PdfView, { pdfjsWorkerSrc: pdfjs, file: this.file, loading: loading, className: className, classnames: cx, width: width, height: height, background: background })) : null)),
            this.renderError()));
    };
    __decorate([
        autobind,
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], PdfViewer.prototype, "renderTip", null);
    return PdfViewer;
}(React.Component));
