...
import { __extends, __assign, __awaiter, __generator, __decorate, __metadata, __spreadArray, __read, __rest } from 'tslib';
import React from 'react';
import { findDOMNode } from 'react-dom';
import Sortable from 'sortablejs';
import omit from 'lodash/omit';
import { getPropValue, resolveVariableAndFilter, anyChanged, isPureVariable, createObject, difference, filter, getMatchedEventTargets, ScopedContext, Renderer, ListStore, isClickOnInput, isVisible, isDisabled, filterClassNameObject } from 'amis-core';
    ...
    ListItem.prototype.renderLeft = function () {
        ...
        if (dragging) {
            ...
            return (React.createElement("div", { className: cx('ListItem-checkBtn') },
                React.createElement(Checkbox, { classPrefix: ns, type: multiple !== false ? 'checkbox' : 'radio', disabled: !checkable, checked: selected, onChange: this.handleCheck, inline: true, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('checkbox') })));
        }
        return null;
    };
