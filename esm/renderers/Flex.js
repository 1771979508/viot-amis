...
var Flex = /** @class */ (function (_super) {
    ...
    Flex.prototype.render = function () {
        ...
        return (React.createElement("div", { style: flexStyle, className: cx('Flex', className, setThemeClassName(__assign(__assign({}, this.props), { name: 'baseControlClassName', id: id, themeCss: themeCss })), setThemeClassName(__assign(__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle }))), "data-id": id },
