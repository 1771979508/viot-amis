...
var Grid2D = /** @class */ (function (_super) {
    ...
    Grid2D.prototype.render = function () {
        var _a = this.props, grids = _a.grids, cols = _a.cols, gap = _a.gap, gapRow = _a.gapRow, width = _a.width, rowHeight = _a.rowHeight, style = _a.style, id = _a.id;
        ...
        return (React.createElement("div", { style: curStyle, "data-id": id }, this.renderGrids()));
    };
