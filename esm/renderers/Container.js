    ...
    Container.prototype.renderBody = function () {
        ...
        var containerBody = children
            ...
            : body
                ...
                : null;
        if (isWrapperBody) {
            return (React.createElement("div", __assign({ className: cx('Container-body', bodyClassName) }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()), containerBody));
        }
        else {
