...
import { isEffectiveApi, until, toNumber, tokenize, createObject, getScrollParent, resizeSensor, isApiOutdated, evalExpressionWithConditionBuilderAsync, filter, filterTarget, isVisible, autobind, evalExpression, ScopedContext, Renderer, ServiceStore, SkipOperation } from 'amis-core';
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, evalExpressionWithConditionBuilderAsync(steps[i].hiddenOn, values)];
                    case 2:
                        hiddenFlag = _b.sent();
    ...
    Wizard.prototype.renderActions = function () {
        ...
        return (React.createElement(React.Fragment, null,
            render("prev-btn", {
                ...
                id: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('button-prev').getTestIdValue()
            }, {
            ...
            render("next-btn", {
                ...
                className: actionClassName,
                level: 'primary',
                id: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('button-next').getTestIdValue()
            }, {
