...
import { filter, resolveEventData, autobind, getVariable, stripNumber, isNumeric, FormItem, isPureVariable, resolveVariableAndFilter } from 'amis-core';
...
var RangeControl = /** @class */ (function (_super) {
    ...
    RangeControl.prototype.resetValue = function () {
        var _a, _b;
        var _c = this.props, multiple = _c.multiple, rawMin = _c.min, rawMax = _c.max, data = _c.data, onChange = _c.onChange, formStore = _c.formStore, store = _c.store, name = _c.name, resetValue = _c.resetValue;
        ...
        var value = this.getFormatValue(pristineVal !== null && pristineVal !== void 0 ? pristineVal : (multiple ? { min: min, max: max } : min));
    ...
    RangeControl.prototype.clearValue = function (type) {
        ...
        var min = resolveNumVariable(rawMin, data, 0);
        var max = resolveNumVariable(rawMax, data, 100);
        var value = this.getFormatValue(multiple ? { min: min, max: max } : min);
        onChange === null || onChange === void 0 ? void 0 : onChange(value);
    };
    /**
     * 获取步长小数精度
    ...
    RangeControl.prototype.getValue = function (value) {
        ...
        return multiple
            ? {
                max: stripNumber(value.max, precision),
                min: stripNumber(value.min, precision)
            }
            : stripNumber(value, precision);
    };
    /**
     * 所有触发value变换 -> onChange
     * @param value
     */
    RangeControl.prototype.handleChange = function (_value) {
        return __awaiter(this, void 0, void 0, function () {
            var value, _a, onChange, dispatchEvent, result, rendererEvent;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        value = this.getValue(_value);
    ...
    RangeControl.prototype.onAfterChange = function () {
        ...
        var result = this.getFormatValue(this.getValue(value));
    ...
    __decorate([
        ...
        __metadata("design:returntype", void 0)
    ], RangeControl.prototype, "resetValue", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
