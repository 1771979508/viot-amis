...
import { filterDate, resolveEventData, getVariable, parseDuration, autobind, FormItem } from 'amis-core';
    ...
    DateRangeControl.prototype.handleChange = function (nextValue) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                dispatchEvent('change', resolveEventData(this.props, { value: nextValue }));
    ...
    DateRangeControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "DateRangeControl"), {
            ...
            React.createElement(DateRangePicker, __assign({}, rest, { mobileUI: mobileUI, classPrefix: ns, popOverContainer: mobileUI
                    ...
                    : rest.popOverContainer || env.getModalContainer, popOverContainerSelector: rest.popOverContainerSelector, onRef: this.getRef, data: data, valueFormat: valueFormat || format, displayFormat: displayFormat || inputFormat, minDate: minDate
