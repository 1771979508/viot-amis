...
import { getVariable, resolveEventData, filterTree, Overlay, PopOver, autobind, OptionsControl } from 'amis-core';
            ...
            return (React.createElement("div", { className: cx(className, "TagControl") },
                ...
                dropdown !== false ? (mobileUI ? (React.createElement(PopUp, { className: cx("Tag-popup"), container: mobileUI
                    ...
                    React.createElement(PopOver, { overlay: true, className: cx('TagControl-popover'), onHide: _this.close },
                        React.createElement(ListMenu, { options: finnalOptions, itemRender: _this.renderItem, highlightIndex: highlightedIndex, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('options'), getItemProps: function (_a) {
                                var item = _a.item, index = _a.index;
                                return (__assign({}, getItemProps({
                                    index: index,
                                    item: item,
