...
import { getVariable, resolveEventData, string2regExp, getTreeAncestors, renderTextByKeyword, flattenTree, getTreeParent, filterTree, getTreeDepth, RootClose, Overlay, PopOver, ucFirst, autobind, OptionsControl } from 'amis-core';
        ...
        return (React.createElement(React.Fragment, null, stack.map(function (options, index) { return (React.createElement("div", { key: index, className: cx('NestedSelect-menu', menuClassName), style: _this.getMenuSelectMenuStyle() },
            ...
            options.map(function (option, idx) {
                ...
                return (React.createElement("div", { key: idx, className: cx('NestedSelect-option', {
                    ...
                    multiple ? (React.createElement(Checkbox, { size: "sm", onChange: _this.handleCheck.bind(_this, option, index, false), trueValue: option[valueField], checked: selfChecked || (!cascade && selfChildrenChecked), partial: !selfChecked, disabled: nodeDisabled, testIdBuilder: itemTIB === null || itemTIB === void 0 ? void 0 : itemTIB.getChild('checkbox') })) : null,
                    React.createElement("div", __assign({ className: cx('NestedSelect-optionLabel', {
                    ...
                    option.children && option.children.length ? (React.createElement("div", __assign({ className: cx('NestedSelect-optionArrowRight', {
                            'is-disabled': nodeDisabled
