...
import { buildApi, isValidApi, getVariable, setVariable, isEffectiveApi, resolveEventData, isMobile, FormItem } from 'amis-core';
...
var MatrixCheckbox = /** @class */ (function (_super) {
    ...
    MatrixCheckbox.prototype.renderInput = function (forceDisabled) {
        ...
        var _b = this.props, rowLabel = _b.rowLabel, disabled = _b.disabled, cx = _b.classnames, multiple = _b.multiple, textAlign = _b.textAlign, xCheckAll = _b.xCheckAll, yCheckAll = _b.yCheckAll, testIdBuilder = _b.testIdBuilder;
                    ...
                    React.createElement("tbody", null, rows.map(function (row, y) { return (React.createElement("tr", { key: y },
                        React.createElement("td", null,
                            multiple && xCheckAll ? (React.createElement(Checkbox, { type: 'checkbox', disabled: forceDisabled || disabled, checked: _this.isRowChecked(value, y), partial: _this.isRowPartialChecked(value, y), onChange: function (checked) {
                                ...
                                }, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild(y) })) : null,
                            row.label,
