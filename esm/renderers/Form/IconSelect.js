...
var IconSelectControl = /** @class */ (function (_super) {
    ...
    IconSelectControl.prototype.renderInputArea = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "IconSelectControl-input-area")) },
            React.createElement("div", { className: cx("".concat(ns, "IconSelectControl-input-icon-show")) },
                React.createElement(Icon, { icon: svg === null || svg === void 0 ? void 0 : svg.svg, className: "icon" })),
            React.createElement("span", { className: cx("".concat(ns, "IconSelectControl-input-icon-id")) }, svg === null || svg === void 0 ? void 0 : svg.name),
            clearable && !disabled && svg ? (React.createElement("a", { onClick: this.handleClear, className: cx("".concat(ns, "IconSelectControl-clear")) },
                React.createElement(Icon, { icon: "input-clear", className: "icon" }))) : null,
            (!svg && placeholder && (React.createElement("span", { className: cx("".concat(ns, "IconSelectControl-input-icon-placeholder")) }, placeholder))) ||
                null));
    };
