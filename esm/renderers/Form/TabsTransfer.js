...
import { filterTree, optionValueCompare, createObject, findTreeIndex, getTree, spliceTree, resolveEventData, autobind, getVariable, toNumber, OptionsControl } from 'amis-core';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        if (term) {
                            return [2 /*return*/, filterTree(option.children || options, function (option, key, level, paths) {
