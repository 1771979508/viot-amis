...
var Panel = /** @class */ (function (_super) {
    ...
    Panel.prototype.render = function () {
        ...
        actions &&
            footerDoms.push(React.createElement("div", { key: "actions", className: cx("Panel-btnToolbar", actionsClassName || "Panel-footer", actionsControlClassName) }, actions));
        footer &&
        ...
        return (React.createElement("div", { className: cx("Panel", className || "Panel--default"), style: style },
            header ? (React.createElement("div", { className: cx(headerClassName || "Panel-heading", headerControlClassName) }, render('header', header, subProps))) : title ? (React.createElement("div", { className: cx(headerClassName || "Panel-heading", headerControlClassName) },
                React.createElement("h3", { className: cx("Panel-title", headerTitleControlClassName) }, render('title', title, subProps)))) : null,
            React.createElement("div", { className: cx(bodyClassName || "Panel-body", bodyControlClassName) }, this.renderBody()),
            footerDom));
    };
    Panel.propsList = [
        'header',
