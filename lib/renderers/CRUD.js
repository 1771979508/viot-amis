...
var CRUD = /** @class */ (function (_super) {
    ...
    CRUD.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (dataInvalid) ;
            ...
            amisCore.isPureVariable(props.source) &&
    ...
    CRUD.prototype.handleFilterInit = function (values) {
        var _a = this.props, defaultParams = _a.defaultParams; _a.data; var store = _a.store, orderBy = _a.orderBy, orderDir = _a.orderDir; _a.dispatchEvent;
    ...
    CRUD.prototype.handleFilterReset = function (values, action) {
        ...
        store.updateQuery(tslib.__assign(tslib.__assign({}, resetQuery), store.pristineQuery), syncLocation && env && env.updateLocation
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, finalReload
                                    ? this.reloadTarget(amisCore.filterTarget(finalReload, data_1), data_1)
                                    : this.search(undefined, undefined, true, true)];
                    }
                });
            }); })
                .catch(function (err) { return tslib.__awaiter(_this, void 0, void 0, function () {
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (dispatchEvent === null || dispatchEvent === void 0 ? void 0 : dispatchEvent('quickSaveFail', amisCore.createObject(this.props.data, {
                                error: err
                            })))];
                        case 1:
                            _a.sent();
                ...
                return tslib.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            finalReload = (_a = options === null || options === void 0 ? void 0 : options.reload) !== null && _a !== void 0 ? _a : reload;
                            return [2 /*return*/, finalReload
                                    ? this.reloadTarget(amisCore.filterTarget(finalReload, data_2), data_2)
                                    : this.search(undefined, undefined, true, true)];
                    }
                });
            }); })
    ...
    CRUD.prototype.handleSaveOrder = function (moved, rows) {
        ...
        return (amisCore.isEffectiveApi(saveOrderApi, model) &&
            store
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (dispatchEvent === null || dispatchEvent === void 0 ? void 0 : dispatchEvent('saveOrderFail', amisCore.createObject(this.props.data, {
                                error: err
                            })))];
                        case 1:
                            _a.sent();
    ...
    CRUD.prototype.reload = function (subpath, query, replace, resetPage, args) {
        if (query) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        if (!(action.actionType === 'selectAll')) return [3 /*break*/, 2];
                        return [2 /*return*/, this.handleSelect(store.items.concat(), [])];
                    case 2:
                        if (!(action.actionType === 'clearAll')) return [3 /*break*/, 3];
                        return [2 /*return*/, this.handleSelect([], store.items.concat())];
                    case 3:
                        if (!(action.actionType === 'select')) return [3 /*break*/, 5];
                    ...
                    case 5: return [2 /*return*/, this.handleAction(undefined, action, data, throwErrors)];
                }
            });
        });
    };
    ...
    CRUD.prototype.renderSwitchPerPage = function (childProps) {
        ...
        return (_J$X_("div", { className: cx('Crud-pageSwitch') },
            ...
            _J$X_(amisUi.Select, { classPrefix: ns, searchable: false, placeholder: __('Select.placeholder'), options: perPages, value: store.perPage + '', onChange: function (value) { return _this.handleChangePage(1, value.value); }, clearable: false, popOverContainer: this.parentContainer, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('perPage') })));
    };
    CRUD.prototype.renderLoadMore = function () {
        var _this = this;
        var _a = this.props, store = _a.store, ns = _a.classPrefix, cx = _a.classnames, __ = _a.translate, testIdBuilder = _a.testIdBuilder;
        var page = store.page, lastPage = store.lastPage;
        return (_J$X_("div", { className: cx('Crud-loadMore') },
            _J$X_(amisUi.Button, tslib.__assign({ disabled: page >= lastPage, disabledTip: __('CRUD.loadMoreDisableTip'), classPrefix: ns, onClick: function () {
                    return _this.search({ page: page + 1, loadDataMode: 'load-more' });
                }, size: "sm" }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('loadMore').getTestId()), __('CRUD.loadMore'))));
    };
    ...
    CRUD.prototype.renderToolbar = function (toolbar, index, childProps, toolbarRenderer) {
        ...
        if (type === 'bulkActions' || type === 'bulk-actions') {
            ...
            if (len) {
                return (_J$X_("div", tslib.__assign({ className: cx_1('Crud-toolbar'), key: index }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('toolbar').getTestId()), children.map(function (_a, index) {
...
/** @class */ ((function (_super) {
    ...
    CRUDRenderer.prototype.reload = function (subpath, query, ctx, silent, replace, args) {
        ...
        return _super.prototype.reload.call(this, subpath, query, replace, (_b = args === null || args === void 0 ? void 0 : args.resetPage) !== null && _b !== void 0 ? _b : true);
    };
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_d) {
                ...
                if (index !== undefined || condition !== undefined) {
                    ...
                    return [2 /*return*/, store.updateData(tslib.__assign(tslib.__assign({}, values), (items ? { items: items } : {})), // 做个兼容
                        undefined, replace)];
                }
            });
        });
