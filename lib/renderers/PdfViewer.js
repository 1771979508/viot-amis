...
var PdfViewer = /** @class */ (function (_super) {
    ...
    PdfViewer.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (amisCore.isApiOutdated(prevProps.src, props.src, prevProps.data, props.data) ||
            amisCore.resolveVariableAndFilter(props.src, props.data, '| raw') !==
                amisCore.resolveVariableAndFilter(prevProps.src, prevProps.data, '| raw')) {
            this.abortLoad();
            setTimeout(function () {
                _this.fetchPdf();
            }, 0);
    ...
    PdfViewer.prototype.renderTip = function () {
        return (_J$X_("div", null,
            _J$X_("p", null, "[PdfViewer]: pdfjsWorkerSrc is required, Please set the `pdfjsWorkerSrc` in env.")));
    };
    PdfViewer.prototype.render = function () {
        ...
        return (_J$X_("div", { ref: this.wrapper },
            this.renderEmpty(),
            !pdfjs ? (this.renderTip()) : (_J$X_(React.Suspense, { fallback: _J$X_("div", null, "...") }, inited && !error ? (_J$X_(PdfView, { pdfjsWorkerSrc: pdfjs, file: this.file, loading: loading, className: className, classnames: cx, width: width, height: height, background: background })) : null)),
            this.renderError()));
    };
    tslib.__decorate([
        amisCore.autobind,
