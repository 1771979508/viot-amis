...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.renderColumn = function (column, key, length) {
        ...
        var _b = this.props, cx = _b.classnames, formMode = _b.formMode, subFormMode = _b.subFormMode, subFormHorizontal = _b.subFormHorizontal, formHorizontal = _b.formHorizontal; _b.translate; var disabled = _b.disabled, data = _b.data, env = _b.env;
        var styleVar = amisCore.buildStyle(column.style, data);
        var id = column.id, themeCss = column.themeCss, wrapperCustomStyle = column.wrapperCustomStyle;
        return (_J$X_("div", { key: key, className: cx(copProps2Class(colProps), fromBsClass(column.columnClassName), (_a = {},
                ...
                _a), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, column), { name: 'baseControlClassName', id: id, themeCss: themeCss })), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, column), { name: 'wrapperCustomStyle', id: id, themeCss: themeCss }))), style: styleVar },
            this.renderChild("column/".concat(key), column.body || '', length, {
                disabled: disabled,
                formMode: column.mode || subFormMode || formMode,
                formHorizontal: column.horizontal || subFormHorizontal || formHorizontal
            }),
            _J$X_(amisCore.CustomStyle, tslib.__assign({}, column, { config: {
    ...
    Grid.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('Grid', (_a = {},
                ...
                _a), className, amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'baseControlClassName', id: id, themeCss: themeCss })), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle }))), style: styleVar, "data-id": id },
