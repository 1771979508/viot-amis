...
var Panel = /** @class */ (function (_super) {
    ...
    Panel.prototype.render = function () {
        var _a = this.props; _a.type; var className = _a.className, style = _a.style, data = _a.data, header = _a.header; _a.body; var render = _a.render, bodyClassName = _a.bodyClassName, headerClassName = _a.headerClassName, actionsClassName = _a.actionsClassName, footerClassName = _a.footerClassName, footerWrapClassName = _a.footerWrapClassName, headerControlClassName = _a.headerControlClassName, headerTitleControlClassName = _a.headerTitleControlClassName, bodyControlClassName = _a.bodyControlClassName, actionsControlClassName = _a.actionsControlClassName; _a.children; var title = _a.title, footer = _a.footer, affixFooter = _a.affixFooter; _a.classPrefix; var cx = _a.classnames; _a.id; var rest = tslib.__rest(_a, ["type", "className", "style", "data", "header", "body", "render", "bodyClassName", "headerClassName", "actionsClassName", "footerClassName", "footerWrapClassName", "headerControlClassName", "headerTitleControlClassName", "bodyControlClassName", "actionsControlClassName", "children", "title", "footer", "affixFooter", "classPrefix", "classnames", "id"]);
        var subProps = tslib.__assign({ data: data }, rest);
        var footerDoms = [];
        var actions = this.renderActions();
        actions &&
            footerDoms.push(_J$X_("div", { key: "actions", className: cx("Panel-btnToolbar", actionsClassName || "Panel-footer", actionsControlClassName) }, actions));
        footer &&
            footerDoms.push(_J$X_("div", { key: "footer", className: cx(footerClassName || "Panel-footer", actionsControlClassName) }, render('footer', footer, subProps)));
        ...
        return (_J$X_("div", { className: cx("Panel", className || "Panel--default"), style: style },
            header ? (_J$X_("div", { className: cx(headerClassName || "Panel-heading", headerControlClassName) }, render('header', header, subProps))) : title ? (_J$X_("div", { className: cx(headerClassName || "Panel-heading", headerControlClassName) },
                _J$X_("h3", { className: cx("Panel-title", headerTitleControlClassName) }, render('title', title, subProps)))) : null,
            _J$X_("div", { className: cx(bodyClassName || "Panel-body", bodyControlClassName) }, this.renderBody()),
            footerDom));
    };
    Panel.propsList = [
        'header',
