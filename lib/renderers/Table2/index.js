...
var Table2 = /** @class */ (function (_super) {
    ...
    Table2.prototype.rowClassName = function (record, rowIndex) {
        ...
        classnames.push(amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'tableRowClassname', id: id, themeCss: themeCss })));
    ...
    Table2.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('Table-render-wrapper', amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle })), {
