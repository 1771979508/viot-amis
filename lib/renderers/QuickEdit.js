    ...
    return function (Component) {
        var QuickEditComponent = /** @class */ (function (_super) {
            ...
            QuickEditComponent.prototype.handleInit = function (values) {
                ...
                var diff = amisCore.difference(values, data);
            ...
            QuickEditComponent.prototype.render = function () {
                ...
                var _b = this.props; _b.buildItemProps; _b.quickEditFormRef; _b.quickEditFormItemRef; var restProps = tslib.__rest(_b, ["buildItemProps", "quickEditFormRef", "quickEditFormItemRef"]);
                if (!quickEdit ||
                    !onQuickChange ||
                ...
                // || readOnly
                    ...
                    return _J$X_(Component, tslib.__assign({}, restProps, { formItemRef: this.formItemRef }));
                }
                if (quickEdit.mode === 'inline' ||
                    quickEdit.isFormMode) {
                    return (_J$X_(Component, tslib.__assign({}, restProps), this.renderInlineForm()));
                }
                else {
                    return (_J$X_(Component, tslib.__assign({}, restProps, { className: cx("Field--quickEditable", className, {
                            in: this.state.isOpened
                        }), tabIndex: quickEdit.focusable === false
                            ? undefined
                            : '0', onKeyUp: disabled ? amisCore.noop : this.handleKeyUp }),
                        _J$X_(Component, tslib.__assign({}, restProps, { contentsOnly: true, noHoc: true })),
                        disabled
                            ? null
