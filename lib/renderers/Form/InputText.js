            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        pristineVal = (_b = amisCore.getVariable((_a = formStore === null || formStore === void 0 ? void 0 : formStore.pristine) !== null && _a !== void 0 ? _a : store === null || store === void 0 ? void 0 : store.pristine, name)) !== null && _b !== void 0 ? _b : resetValue;
                        return [4 /*yield*/, dispatchEvent('change', amisCore.resolveEventData(this.props, { value: pristineVal }))];
                    case 1:
                        changeEvent = _d.sent();
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', amisCore.resolveEventData(this.props, { value: resetValue }))];
                    case 2:
                        changeEvent = _b.sent();
                        if (changeEvent === null || changeEvent === void 0 ? void 0 : changeEvent.prevented) {
                            return [2 /*return*/];
    ...
    TextControl.prototype.renderBody = function (body) {
        ...
        var classNames = !isStatic
            ...
            : cx("".concat(ns, "TextControl"), (_b = {},
                ...
                _b));
        return (_J$X_("div", { className: classNames, style: style },
