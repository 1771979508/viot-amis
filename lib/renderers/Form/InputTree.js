...
var TreeControl = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        selectedItems = amisUi.value2array(value, {
                            multiple: multiple,
                            delimiter: delimiter,
                        ...
                        if (multiple && searchable && originSelectedItems.length) {
                            originSelectedItems.forEach(function (origin) {
                                var exists = amisCore.findTree(filteredOptions, function (item) { return item[valueField || 'value'] === origin[valueField || 'value']; });
                                if (!exists) {
    ...
    TreeControl.prototype.render = function () {
        ...
        return (_J$X_("div", tslib.__assign({ className: cx__default["default"]("".concat(ns, "TreeControl"), className, treeContainerClassName, {
