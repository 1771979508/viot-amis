        ...
        return (_J$X_("div", { className: cx('ExcelControl', className) },
            _J$X_(DropZone__default["default"], { key: "drop-zone", onDrop: this.handleDrop, accept: ".xlsx,.xls", multiple: false, disabled: disabled }, function (_a) {
                ...
                return (_J$X_("section", { className: cx('ExcelControl-container', className) },
                    _J$X_("div", tslib.__assign({}, getRootProps({ className: cx('ExcelControl-dropzone') }), testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
                        _J$X_("input", tslib.__assign({}, getInputProps(), testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('input').getTestId())),
