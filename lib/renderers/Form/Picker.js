...
var PickerControl = /** @class */ (function (_super) {
    ...
    function PickerControl(props) {
        ...
        _this.toDispose = [];
        _this.mounted = false;
        var formInited = props.formInited, addHook = props.addHook, formItem = props.formItem;
        var onIninted = function () { return tslib.__awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fetchOptions()];
                    case 1:
                        _a.sent();
                        this.mounted &&
                            this.toDispose.push(mobx.reaction(function () { return JSON.stringify(formItem === null || formItem === void 0 ? void 0 : formItem.tmpValue); }, function () { return _this.fetchOptions(); }));
                        return [2 /*return*/];
                }
            });
        }); };
    ...
    PickerControl.prototype.buildSchema = function (props) {
        ...
        return tslib.__assign(tslib.__assign({ checkOnItemClick: true, listItem: {
                title: "${".concat(props.labelField || 'label', "|raw}")
            } }, props.pickerSchema), { labelTpl: (_b = (_a = props.pickerSchema) === null || _a === void 0 ? void 0 : _a.labelTpl) !== null && _b !== void 0 ? _b : props.labelTpl, type: 'crud', pickerMode: true, syncLocation: false, filterCanAccessSuperData: false, api: isScopeData ? null : props.source, source: isScopeData ? props.source : null, keepItemSelectionOnPageChange: true, valueField: props.valueField, labelField: props.labelField, 
            // 不支持批量操作，会乱套
    ...
    PickerControl.prototype.renderBody = function (_a) {
        ...
        var _c = this.props, render = _c.render, selectedOptions = _c.selectedOptions, options = _c.options, multiple = _c.multiple, valueField = _c.valueField, embed = _c.embed, source = _c.source, strictMode = _c.strictMode, testIdBuilder = _c.testIdBuilder;
        ...
        return render('modal-body', this.state.schema, tslib.__assign({ value: selectedOptions, valueField: valueField, primaryField: valueField, options: source ? [] : options, multiple: multiple, strictMode: strictMode, onSelect: embed ? this.handleSelect : undefined, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('body-schema'), ref: this.crudRef, popOverContainer: popOverContainer }, (embed ||
    ...
    PickerControl.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx("PickerControl", { 'is-mobile': mobileUI }, className) },
            embed ? (_J$X_("div", { className: cx('Picker') }, this.renderBody({ popOverContainer: popOverContainer }))) : (_J$X_("div", { className: cx("Picker", {
                ...
                _J$X_("div", { onClick: this.handleClick, className: cx('Picker-input', disabled && 'is-disabled', this.state.isFocused && 'is-focused', amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickControlClassName', id: id, themeCss: themeCss || css }))) },
                    !selectedOptions.length && placeholder ? (_J$X_("div", { className: cx('Picker-placeholder') }, __(placeholder))) : null,
                    _J$X_("div", tslib.__assign({ className: cx('Picker-valueWrap') }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
                        this.renderValues(),
                    ...
                    _J$X_("span", tslib.__assign({ onClick: this.open, className: cx('Picker-btn') }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('picker-open-btn').getTestId()),
    ...
    ], PickerControl.prototype, "fetchOptions", null);
    tslib.__decorate([
        amisCore.autobind,
        tslib.__metadata("design:type", Function),
