...
var IconSelectControl = /** @class */ (function (_super) {
    ...
    IconSelectControl.prototype.getValueBySvg = function (svg) {
        ...
        if (typeof svg !== 'string') {
            return tslib.__assign(tslib.__assign({}, svg), { svg: (_a = svg.svg) === null || _a === void 0 ? void 0 : _a.replace(/'/g, '') });
        }
    ...
    IconSelectControl.prototype.renderInputArea = function () {
        ...
        return (_J$X_("div", { className: cx__default["default"]("".concat(ns, "IconSelectControl-input-area")) },
            _J$X_("div", { className: cx__default["default"]("".concat(ns, "IconSelectControl-input-icon-show")) },
                _J$X_(amisUi.Icon, { icon: svg === null || svg === void 0 ? void 0 : svg.svg, className: "icon" })),
            _J$X_("span", { className: cx__default["default"]("".concat(ns, "IconSelectControl-input-icon-id")) }, svg === null || svg === void 0 ? void 0 : svg.name),
            clearable && !disabled && svg ? (_J$X_("a", { onClick: this.handleClear, className: cx__default["default"]("".concat(ns, "IconSelectControl-clear")) },
                _J$X_(amisUi.Icon, { icon: "input-clear", className: "icon" }))) : null,
            (!svg && placeholder && (_J$X_("span", { className: cx__default["default"]("".concat(ns, "IconSelectControl-input-icon-placeholder")) }, placeholder))) ||
                null));
    };
