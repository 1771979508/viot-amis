...
var TreeSelectControl = /** @class */ (function (_super) {
    ...
    TreeSelectControl.prototype.resolveOption = function (options, value) {
        var _this = this;
        return amisCore.findTree(options, function (item) {
    ...
    TreeSelectControl.prototype.handleFocus = function (e) {
        ...
        dispatchEvent('focus', amisCore.resolveEventData(this.props, { value: value, item: item, items: items }));
    };
    TreeSelectControl.prototype.handleBlur = function (e) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent, value = _a.value;
        var items = this.resolveOptions();
        var item = this.resolveOption(items, value);
        dispatchEvent('blur', amisCore.resolveEventData(this.props, { value: value, item: item, items: items }));
    };
    ...
    TreeSelectControl.prototype.mergeOptions = function (options) {
        ...
        if (Array.isArray(selectedOptions) && selectedOptions.length) {
            selectedOptions.forEach(function (option) {
                if (!amisCore.findTree(combinedOptions, function (item) { return item.value == option.value; })) {
    ...
    TreeSelectControl.prototype.render = function () {
        ...
        var resultValue = multiple
            ...
            : selectedOptions.length
                ...
                : '';
        return (_J$X_("div", tslib.__assign({ ref: this.container, className: cx("TreeSelectControl", className) }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
            _J$X_(amisUi.ResultBox, { popOverContainer: popOverContainer || env.getModalContainer, maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover, disabled: disabled, ref: this.targetRef, placeholder: __(placeholder !== null && placeholder !== void 0 ? placeholder : 'placeholder.empty'), inputPlaceholder: '', className: cx("TreeSelect", {
                    ...
                    (multiple || !resultValue), hasDropDownArrow: true, readOnly: mobileUI, mobileUI: mobileUI, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('result-box') }, loading ? (_J$X_(amisUi.Spinner, { loadingConfig: loadingConfig, size: "sm" })) : undefined),
