        ...
        return (_J$X_("div", { className: cx('FileControl', className) },
            ...
            _J$X_(DropZone__default["default"], { disabled: disabled, key: "drop-zone", ref: this.dropzone, onDrop: this.handleDrop, onDropRejected: this.handleDropRejected, accept: accept === '*' ? '' : accept, multiple: multiple }, function (_a) {
                ...
                return (_J$X_("div", tslib.__assign({}, getRootProps({
                    ...
                    _J$X_("input", tslib.__assign({ disabled: disabled }, getInputProps(), { capture: capture }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('input').getTestId())),
            ...
            failed ? (_J$X_("div", { className: cx('FileControl-sum') },
                ...
                __('File.failed'))) : null,
            !autoUpload && !hideUploadButton && files.length ? (_J$X_(amisUi.Button, { level: "default", testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('upload'), disabled: !hasPending, className: cx('FileControl-uploadBtn', btnUploadClassName), onClick: this.toggleUpload }, __(uploading ? 'File.pause' : 'File.start'))) : null));
    };
