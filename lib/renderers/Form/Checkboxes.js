...
var CheckboxesControl = /** @class */ (function (_super) {
    ...
    CheckboxesControl.prototype.renderItem = function (option, index) {
        ...
        return (_J$X_(amisUi.Checkbox, { className: itemClassName, key: index, onChange: function () { return onToggle(option); }, checked: !!~selectedOptions.indexOf(option), disabled: disabled || option.disabled, inline: inline, labelClassName: optionLabelClassName || labelClassName, description: option.description, optionType: optionType, testIdBuilder: itemTestIdBuilder },
            menuTpl
