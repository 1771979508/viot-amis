...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.rowPathPlusOffset = function (path, offset) {
    ...
    Table.prototype.handleRowClick = function (item, index) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent, _b = _a.offset, offset = _b === void 0 ? 0 : _b; _a.store; var data = _a.data;
    ...
    Table.prototype.renderHeadCell = function (column, props) {
        var _this = this;
        var _a, _b, _c, _d, _e;
        var _f = this.props, store = _f.store, query = _f.query, onQuery = _f.onQuery, render = _f.render, ns = _f.classPrefix, resizable = _f.resizable, cx = _f.classnames, autoGenerateFilter = _f.autoGenerateFilter, dispatchEvent = _f.dispatchEvent, data = _f.data, testIdBuilder = _f.testIdBuilder;
        ...
        if (!column.searchable && column.filterable && column.name && onQuery) {
            affix.push(_J$X_(HeadCellFilterDropdown.HeadCellFilterDropDown, tslib.__assign({ key: "table-head-filter" }, this.props, { onQuery: onQuery, name: column.name, type: column.type, data: query, superData: amisCore.createObject(data, query), filterable: column.filterable, popOverContainer: this.getPopOverContainer, testIdBuilder: tIdCell === null || tIdCell === void 0 ? void 0 : tIdCell.getChild('filter') })));
        }
    ...
    Table.prototype.renderCell = function (region, column, item, props, ignoreDrag) {
        ...
        var _a = this.props, render = _a.render, store = _a.store, ns = _a.classPrefix, cx = _a.classnames, canAccessSuperData = _a.canAccessSuperData, itemBadge = _a.itemBadge, translate = _a.translate, testIdBuilder = _a.testIdBuilder;
    ...
    Table.prototype.renderExportExcel = function (toolbar) {
        ...
        return render('exportExcel', tslib.__assign(tslib.__assign({ label: __('CRUD.exportExcel') }, toolbar), { type: 'button' }), {
            ...
            onAction: function () {
                ...
                Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['exceljs'], function(mod) {fullfill(tslib.__importStar(mod))})})}).then(function (E) { return tslib.__awaiter(_this, void 0, void 0, function () {
                    var ExcelJS, error_1;
                    return tslib.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
    ...
    Table.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, store = _a.store, cx = _a.classnames; _a.affixColumns; var affixHeader = _a.affixHeader, autoFillHeight = _a.autoFillHeight, autoGenerateFilter = _a.autoGenerateFilter, mobileUI = _a.mobileUI, testIdBuilder = _a.testIdBuilder, id = _a.id;
        ...
        return (_J$X_("div", tslib.__assign({ ref: this.dom, className: cx('Table', { 'is-mobile': mobileUI }, className, {
...
/** @class */ ((function (_super) {
     ...
     * @returns
     */
    TableRenderer.prototype.getEventTargets = function (ctx, index, condition, oldCondition) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var store;
            return tslib.__generator(this, function (_a) {
                store = this.props.store;
                return [2 /*return*/, amisCore.getMatchedEventTargets(store.rows, ctx || this.props.data, index, condition, oldCondition)];
            });
        });
    };
    TableRenderer.prototype.reload = function (subPath, query, ctx, silent, replace, args) {
        var _a, _b, _c;
        return tslib.__awaiter(this, void 0, void 0, function () {
            var targets, scoped;
            var _this = this;
    ...
    TableRenderer.prototype.doAction = function (action, ctx, throwErrors, args) {
        return tslib.__awaiter(this, void 0, void 0, function () {
