...
function HeadCellSearchDropDown(_a) {
    ...
    return (_J$X_("span", tslib.__assign({ ref: ref, className: cx("".concat(ns, "TableCell-searchBtn"), isActive ? 'is-active' : '', isOpened ? 'is-opened' : '') }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
