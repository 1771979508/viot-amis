...
var TableRow = /** @class */ (function (_super) {
    ...
    TableRow.prototype.handleChange = function (value, name, submit, changePristine) {
        ...
        var data = {};
        var keyPath = amisCore.keyToPath(name);
        // 如果是带路径的值变化，最好是能保留原来的对象的其他属性
        if (keyPath.length > 1) {
            data[keyPath[0]] = tslib.__assign({}, item.data[keyPath[0]]);
        }
    ...
    TableRow.prototype.render = function () {
        ...
        return (_J$X_("tr", tslib.__assign({ ref: trRef, onClick: checkOnItemClick || itemAction || (onEvent === null || onEvent === void 0 ? void 0 : onEvent.rowClick)
                ? this.handleItemClick
