    ...
    Container.prototype.renderBody = function () {
        ...
        var containerBody = children
            ...
            : body
                ...
                : null;
        if (isWrapperBody) {
            return (_J$X_("div", tslib.__assign({ className: cx('Container-body', bodyClassName) }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()), containerBody));
        }
        else {
